...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        with torch.no_grad():
            ...
            if opt.pack == False or key_frame ==0:
                ...
                if img.size(2) == packed_img.size(2) and img.size(3) == packed_img.size(3):
                    key_frame=0 
    ...
    if opt.pack == False:
        ...
        load_wb = load_workbook(f'excel_result/{opt.dataset_name}_results_packanddetect.xlsx', data_only = True)
    ...
    if opt.pack == False:
        ...
        write_wb.save(f'excel_result/{opt.dataset_name}_results_packanddetect.xlsx')
